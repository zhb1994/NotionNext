...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bo's Blog', // 您的昵称 例如 tangly1024
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'zhb1994.ink', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
